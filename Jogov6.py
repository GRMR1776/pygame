...
#ESSA VERSÃO VAI TER OS PONTOS DO JOGADOR A CADA ALVO QUE ELE ACERTAR!!!
import pygame
import random
...
meteor_img = pygame.image.load('imagens/alvo.png').convert_alpha()
meteor_img = pygame.transform.scale(meteor_img, (METEOR_WIDTH, METEOR_HEIGHT))
ship_img = pygame.image.load('imagens/scar.jpg').convert_alpha()
ship_img = pygame.transform.scale(ship_img, (SHIP_WIDTH, SHIP_HEIGHT))
bullet_img = pygame.image.load('imagens/laserRed16.png').convert_alpha()
